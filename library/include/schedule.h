...
private:
     ...
     */
    std::priority_queue<Message*, std::vector<Message*>, std::greater<Message*>> priorityQueue;
...
public:
     ...
     */
    Message* popMessage(SimTime_t pTime, SimTime_t pOffset = SIMULATION_TIME_OFFSET);
