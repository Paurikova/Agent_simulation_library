...
void Agent::process(ServiceId_t pServiceId, AgentId_t pSender, AgentId_t  pReceiver, SimTime_t execTime, std::unordered_map<std::string, std::variant<int, double, std::string>> args) {
