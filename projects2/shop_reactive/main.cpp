...
int main(int argc, char** argv) {{
    ...
    std::unique_ptr<Agent> aGraph2 = std::make_unique<Agent>(2, aManager.get(), rGraph2ReactiveReasoning.get());
    ...
    std::unique_ptr<Agent> aCustomer4 = std::make_unique<Agent>(4, aManager.get(), rCustomer4ReactiveReasoning.get());
