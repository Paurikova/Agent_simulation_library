...
void Agent1ReactiveReasoning::acceptCustomer(int pSender, int pReceiver, SimTime_t pExecTime) {
    //add your code
}
void Agent1ReactiveReasoning::generateCustomer(int pSender, int pReceiver, SimTime_t pExecTime) {
    //add your code
}
