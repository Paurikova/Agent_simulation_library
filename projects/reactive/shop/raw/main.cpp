...
int main(int argc, char** argv) {{
    ...
    aManager->registerAgent(aCustomer2.get());
    ...
    aManager->registerAgent(aCash6.get());
    ...
    aManager->registerAgent(aLine5.get());
    ...
    aManager->registerAgent(aGraph4.get());
    ...
    aManager->registerAgent(aShop3.get());
