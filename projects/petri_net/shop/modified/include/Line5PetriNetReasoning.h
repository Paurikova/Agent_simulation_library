...
private:
    ...
    //nodes
    NodeId_t hasCustomer_fun363(int pSender, int pReceiver, SimTime_t pExecTime, State* state);
    ...
    NodeId_t addToLine_fun349(int pSender, int pReceiver, SimTime_t pExecTime, State* state);
