...
int main(int argc, char** argv) {
    ...
    std::unique_ptr<Shop3PetriNetReasoning> rShop = std::make_unique<Shop3PetriNetReasoning>(4, stateShop.get(), logger.get());
    ...
    std::unique_ptr<Cash6PetriNetReasoning> rCash1 = std::make_unique<Cash6PetriNetReasoning>(std::vector<int>{100, 500, 900}, 500, 80, stateShop.get(), logger.get());
    std::unique_ptr<Cash6PetriNetReasoning> rCash2 = std::make_unique<Cash6PetriNetReasoning>(std::vector<int>{200, 600, 1000}, 500, 80, stateShop.get(), logger.get());
