...
NodeId_t Cash5PetriNetReasoning::endCustomer_fun321(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    //add your code
...
NodeId_t Cash5PetriNetReasoning::Code_code316(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    //add your code
    StateLine* stateLine = dynamic_cast<StateLine*>(state);
...
NodeId_t Cash5PetriNetReasoning::Code_code313(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    //add your code
    StateLine* stateLine = dynamic_cast<StateLine*>(state);
...
NodeId_t Cash5PetriNetReasoning::Condition_cond308(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    StateLine* stateLine = dynamic_cast<StateLine*>(state);
...
NodeId_t Cash5PetriNetReasoning::processCustomer_fun305(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    //add your code
    StateLine* stateLine = dynamic_cast<StateLine*>(state);
...
NodeId_t Cash5PetriNetReasoning::processCustomer_fun302(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    //add your code
    StateLine* stateLine = dynamic_cast<StateLine*>(state);
...
NodeId_t Cash5PetriNetReasoning::Condition_cond296(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    StateLine* stateLine = dynamic_cast<StateLine*>(state);
...
NodeId_t Cash5PetriNetReasoning::Code_code292(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    //add your code
    StateLine *stateLine = dynamic_cast<StateLine *>(state);
...
NodeId_t Cash5PetriNetReasoning::Code_code288(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    //add your code
    StateLine *stateLine = dynamic_cast<StateLine *>(state);
...
NodeId_t Cash5PetriNetReasoning::Condition_cond283(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    StateLine* stateLine = dynamic_cast<StateLine*>(state);
...
NodeId_t Cash5PetriNetReasoning::acceptCustomer_fun280(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    //add your code
    StateLine *stateLine = dynamic_cast<StateLine *>(state);
...
NodeId_t Cash5PetriNetReasoning::acceptCustomer_fun277(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    //add your code
    StateLine *stateLine = dynamic_cast<StateLine *>(state);
...
NodeId_t Cash5PetriNetReasoning::Condition_cond272(int pSender, int pReceiver, SimTime_t pExecTime, State* state) {
    StateLine *stateLine = dynamic_cast<StateLine *>(state);
...
void Cash5PetriNetReasoning::registerNodes() {
    //registration
...
void Cash5PetriNetReasoning::registerServices() {
    //services
