...
int main(int argc, char** argv) {{
    ...
    std::unique_ptr<Agent> aShop4 = std::make_unique<Agent>(4, aManager.get(), rShop4PetriNetReasoning.get());
    ...
    std::unique_ptr<Agent> aGraph3 = std::make_unique<Agent>(3, aManager.get(), rGraph3ReactiveReasoning.get());
