...
//functions
void Shop::open(int pSender, int pReceiver, SimTime_t pExecTime, std::unordered_map<std::string, std::variant<int, float, std::string, std::vector<float>>> args) {
    std::cout << pReceiver << ": open" << std::endl;
    std::cout << "Shopping is open" << std::endl;
}

void Shop::close(int pSender, int pReceiver, SimTime_t pExecTime, std::unordered_map<std::string, std::variant<int, float, std::string, std::vector<float>>> args) {
    std::cout << pReceiver << ": close" << std::endl;
    std::cout << "Shop is close" << std::endl;
}

void Shop::newCustomer(int pSender, int pReceiver, SimTime_t pExecTime, std::unordered_map<std::string, std::variant<int, float, std::string, std::vector<float>>> args) {
...
void Shop::removeCustomer(int pSender, int pReceiver, SimTime_t pExecTime, std::unordered_map<std::string, std::variant<int, float, std::string, std::vector<float>>> args) {
...
void Shop::endShoppingTime(int pSender, int pReceiver, SimTime_t pExecTime, std::unordered_map<std::string, std::variant<int, float, std::string, std::vector<float>>> args) {
    std::cout << pReceiver << ": endShoppingTime" << std::endl;
    sendMessage(5, pExecTime, pReceiver, 4);
    sendMessage(5, pExecTime, pReceiver, 5);
}

void Shop::custInLinesCheck(int pSender, int pReceiver, SimTime_t pExecTime, std::unordered_map<std::string, std::variant<int, float, std::string, std::vector<float>>> args) {
...
void Shop::registerFunctions() {
    ...
    registerFunction(6, [this](int pSender, int pReceiver, SimTime_t pExecTime, std::unordered_map<std::string, std::variant<int, float, std::string, std::vector<float>>> args) {
