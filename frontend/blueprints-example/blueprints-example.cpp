    ...
    public Application
{
    ...
    void OnStart() override
    {
        ...
        //ZMENA
        int cons = 1;
        m_Links.push_back(Link(GetNextLinkId(), m_Nodes[5 - cons].Outputs[0].ID, m_Nodes[6 - cons].Inputs[0].ID));
        m_Links.push_back(Link(GetNextLinkId(), m_Nodes[5 - cons].Outputs[0].ID, m_Nodes[7 - cons].Inputs[0].ID));

        m_Links.push_back(Link(GetNextLinkId(), m_Nodes[14 - cons].Outputs[0].ID, m_Nodes[15 - cons].Inputs[0].ID));
