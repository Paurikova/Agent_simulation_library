...
int main(int argc, char** argv) {
    ...
    Manager* rManager = new Manager(10, 5, logger);
    ...
    Shop* rShop = new Shop(3, stateShop, logger);
    ...
    Cash* rCash1 = new Cash({100, 500, 900}, 100, 10, stateShop, logger);
    Cash* rCash2 = new Cash({200, 600, 1000}, 200, 7, stateShop, logger);
    ...
    Graph* rGraph = new Graph(window, stateShop, logger);
